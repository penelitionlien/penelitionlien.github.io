...
var documents = [{
    ...
    "url": "/example/",
    "title": "",
    "body": "Embed Youtube{% include youtubePlayer. html id=page. youtubeId %} Embed Vimeo{% include vimeoPlayer. html id=page. vimeoId %} Embed Twitch{% include twitchPlayer. html id=page. twitchId %} Embed Streamable{% include streamablePlayer. html id=page. streamableId %} Embed Mixer{% include mixerPlayer. html id=page. mixerId %} Embed Google Drive{% include googleDrivePlayer. html id=page. driveId %} Embed 20Detik{% include 20detikPlayer. html id=page. detikId %} Embed Dailymotion{% include dailymotionPlayer. html id=page. dailymotionId %} Embed Metube{% include metubePlayer. html id=page. metubeId %} Embed Vidio{% include vidioPlayer. html id=page. vidioId %} Embed LINE Today{% include linetodayPlayer. html id=page. linetodayId country=page. countryId %} "
    }, {
    "id": 8,
    "url": "/",
    "title": "Home",
